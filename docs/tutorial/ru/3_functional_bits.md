...
Мы используем библиотеку `kungfu`, чтобы реализовать функциональную основу в telegrinder. Давай рассмотрим простые примеры, чтобы глубже понять концепцию.

Напишем функцию с использованием `kungfu`, чтобы продемонстрировать подход:
...
kungfu предоставляет множество утилит для работы со своими объектами.
...
[Продвинутая документация со всеми методами](https://github.com/timoniq/kungfu/blob/main/docs/result.md#application)
