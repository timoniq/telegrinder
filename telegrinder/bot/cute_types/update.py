...
class UpdateCute(BaseCute[Update], Update, kw_only=True):
    ...
    business_connection: Option[BusinessConnectionCute] = field(
        default=..., converter=From["BusinessConnectionCute | None"]
    )
    ...
    deleted_business_messages: Option[BusinessMessagesDeletedCute] = field(
        default=..., converter=From["BusinessMessagesDeletedCute | None"]
    )
    """Optional. Messages were deleted from a connected business account."""

    message_reaction: Option[MessageReactionUpdatedCute] = field(
        default=..., converter=From["MessageReactionUpdatedCute | None"]
    )
    ...
    message_reaction_count: Option[MessageReactionCountUpdatedCute] = field(
        default=..., converter=From["MessageReactionCountUpdatedCute | None"]
    )
    ...
    chosen_inline_result: Option[ChosenInlineResultCute] = field(
        default=..., converter=From["ChosenInlineResultCute | None"]
    )
    ...
    chat_boost: Option[ChatBoostUpdatedCute] = field(default=..., converter=From["ChatBoostUpdatedCute | None"])
    """Optional. A chat boost was added or changed. The bot must be an administrator
    in the chat to receive these updates."""

    removed_chat_boost: Option[ChatBoostRemovedCute] = field(default=..., converter=From["ChatBoostRemovedCute | None"])
