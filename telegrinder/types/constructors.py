...
class BroadcastStats(BaseModel):
    ...
    recent_message_interactions: typing.Optional[
        typing.List["MessageInteractionCounters"]
    ] = None
...
class GroupCallParticipantVideo(BaseModel):
    ...
    source_groups: typing.Optional[
        typing.List["GroupCallParticipantVideoSourceGroup"]
    ] = None
